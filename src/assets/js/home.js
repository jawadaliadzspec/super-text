...
const translations = {
    en: {
        ...
        communitiesSectionParagraph:"Empower your community with Supertext. We have designed a space where everyone can be seen, heard and valued.Connect and grow with others who share your interests, and achieve more together! It's easy to create your own community or to join an existing one.",
        featureSectionHeading:"Features for a better experience",
        slideOneHeading:"Mention",
        slideOneParagraph:"Draw attention with our mention feature. Just add '@' before a name in your message.",
        ...
        testimonialSlideOneParagraph:"I use Supertext to chat with my parents in my hometown, they have no internet connection. Only Supertext can send app messages through SMS. Thank you Supertext!",
        superTextHeading:"Why use Supertext? ",
        superTextSlideOneHeading:"University groups",
        superTextSlideOneParagraph:"Streamline your school events with dedicated channels. Quickly set up polls to decide on activities everyone loves, and send instant updates to keep the whole group informed. Organizing has never been this easy or fun!",
        superTextSlideTwoHeading:"Communities",
        superTextSlideTwoParagraph:"Transform your community with tailored features like multi-level announcements, co-admin support, and diverse communication channels. Whether it’s private chats for sensitive topics or large-scale broadcasts, manage it all with ease and insight.",
        superTextSlideThreeHeading:"Family and friends",
        superTextSlideThreeParagraph:"Keep your loved ones closer, no matter the distance across the Indonesian archipelago. Our hybrid messaging ensures you can stay connected through SMS when the internet lets you down. Because family and friends should always be just a message away.",
    ...
    ind: {
        ...
        slideOneParagraph:"Tarik perhatian dengan fitur sebutan kami. Cukup tambahkan '@' sebelum nama di pesanmu.",
        ...
        superTextSlideOneParagraph:"Mempermudah acara sekolah kalian dengan channel khusus. Siapkan pilihan suara dengan cepat untuk memutuskan aktivitas yang disukai semua orang, dan kirim kabar terbaru secara  instan untuk memberitahu seluruh grup. Mengorganisir tidak pernah semudah atau semenyenangkan ini!",
        superTextSlideTwoHeading:"Komunitas",
        superTextSlideTwoParagraph:"Ubah komunitas kalian dengan fitur yang disesuaikan seperti pengumuman multi-level, dukungan admin, dan saluran komunikasi yang beragam. Baik itu obrolan pribadi untuk topik sensitif atau siaran skala besar, kelola semuanya dengan mudah dan berwawasan.",
    ...
    sw: {
        ...
        communitiesSectionParagraph:"Doesn’t a friend have Supertext? No problem! Simply add anyone from your phone book, and they can start chatting with you in the group directly via SMS. Sending an SMS costs the same as a regular SMS, regardless of group size (free if included in your subscription).",
        featureSectionHeading:"Features for a better experience",
        slideOneHeading:"Mention",
        slideOneParagraph:"Draw attention with our mention feature. Just add '@' before a name in your message.",
        slideTwoHeading:"React",
        slideTwoParagraph:"Share your feelings by reacting with emojis instead of a text message.",
        slideThreeHeading:"Stickers",
        slideThreeParagraph:"Send custom stickers, created by our handpicked illustrators, to express yourself to the fullest.",
        slideFourHeading:"",
        slideFourParagraph:"",
        testimonialsHeading:"What do our users say?",
        testimonialSlideOneHeading:"",
